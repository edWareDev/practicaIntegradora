...
async function validateLista(lista, itemsHTML, index = 0) {
    ...
    if (item.status?.estadoCp) {
        ...
        validateLista(lista, itemsHTML, index)
    ...
    if (index < lista.length - 1) {
        return validateLista(lista, itemsHTML, index + 1);
    } else {
        createXLSFile()
        return lista;
    }
...
// CODIGO DE FUNCIONAMIENTO EN UN SOLO BLOQUE
...
// CODIGO DE FUNCIONAMIENTO EN LOTES
...
//                 i--;
//             } else if (itemStatus.success === false) {
